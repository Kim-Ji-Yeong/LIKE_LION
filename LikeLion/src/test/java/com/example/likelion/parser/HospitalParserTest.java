package com.example.likelion.parser;


import com.example.likelion.week4.Day6.hospital.domain.Hospital;
import com.example.likelion.week4.Day6.hospital.parser.HospitalParser;
...
class HospitalParserTest {
    ...
    @Test
    @DisplayName("insert쿼리를 잘만드는지 test")

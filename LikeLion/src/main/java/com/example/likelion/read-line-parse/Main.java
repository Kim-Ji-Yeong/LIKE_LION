package com.example.likelion.read;
...
public class Main {
    public static void main(String[] args) throws IOException {
        com.line.readlineparser.FileController<Hospital> hospitalFileController = new com.line.readlineparser.FileController<>(new HospitalParser());
